...
<article class="projets" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
							...
							<picture class="article_home_images" border=”0” style=”display:block;” >
							<img <?php awesome_acf_responsive_image(get_field( 'image' ),'2-width','640px'); ?>  border=”0” style=”display:block;” alt="text" />
							</picture>
							</a>
